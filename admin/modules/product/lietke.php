                ...
                <div class="main-pane-top d-flex space-between align-center justify-center">
                    <div class="input__search p-relative">
                        <form class="search-form" action="?action=product&query=product_search" method="POST">
                            ...
                            <input type="search" class="form-control" title="Nhập vào tên sản phẩm để tìm kiếm" name="product_search" placeholder="Tìm kiếm theo..." title="Search here">
                        </form>
                    </div>
                </div>
