                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo date('d/m/Y', strtotime($row['inventory_date'])); ?></td>
...
<div class="dialog__control">
    <div class="control__box">
        <a href="#" class="button__control btn__wanning" onclick="return confirm('Bạn có thực sự muốn xóa phiếu nhập này không?')" id="btnDelete">Xóa</a>
    </div>
</div>
<script>
    var url;
